...
Contributors: hasthemes, tarekht, aslamhasib, alberuni-azad
Tags: woocommerce, color swatch, variation swatches, woocommerce variation, product attributes, woocommerce attributes, Variable product, product color, woocommerce variation swatches, variation swatches for woocommerce, woocommerce color swatches, color attributes
...
[Live Demo](https://theplugindemo.com/swatchly/) | [Documentation](https://theplugindemo.com/swatchly/documentation/) | [Purchase Pro](https://hasthemes.com/plugins/swatchly-product-variation-swatches-for-woocommerce-products/) | [Support](https://hasthemes.com/contact-us)
...
1. Auto convert variation dropdowns to image Swatch for idividual product
...
* Fixed: Product loop gallary navingation doesn't change after variation update
* Updated: Readme file
...
== Screenshots ==
1. Quickly Nagvigate to the Settings page of the plugin
