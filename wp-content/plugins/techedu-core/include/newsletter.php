 ...
 */
 if( !class_exists('Techeduem_Newsletter_Widget') ){
	class Techeduem_Newsletter_Widget extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_ops = array( 'description' => esc_html__('Techedu contact for address email and phone no.','techeduem'),'customize_selective_refresh' => true, );
			parent:: __construct('Techeduem_Newsletter_Widget',
				esc_html__('Techedu: Newsletter','techeduem'), $widget_ops );
		}
		/**
		...
		public function widget($args, $instance){			
			...
			?>
				<div class="news-letter">
					...
					<?php echo wp_kses_post($args['before_title']); ?><?php echo esc_html( $title ); ?><?php echo wp_kses_post($args['after_title']); ?>
		...
		public function form($instance){
			...
			?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'title' ) ); ?>"><?php esc_html_e('Title:', 'techeduem');?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:' ,'techeduem') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('shortcode')); ?>"><?php esc_html_e('Shortcode:' ,'techeduem') ?></label>
...
function Techeduem_Newsletter_Widget() {
    register_widget( 'Techeduem_Newsletter_Widget' );
}
add_action( 'widgets_init', 'Techeduem_Newsletter_Widget' ); 