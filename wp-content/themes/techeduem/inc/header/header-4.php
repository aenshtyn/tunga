...
$techeduem_opt = techeduem_get_opt();
$header_four_mini_c_show = isset($techeduem_opt['header_four_mini_cart']) ? $techeduem_opt['header_four_mini_cart'] : '';
if ($header_four_mini_c_show) {
    ...
    <div class="header-section header-transparent section">
        <div class="<?php echo esc_attr($header_width); ?>">
            <div class="row align-items-center header-menu-right">
                ...
                <?php if ($header_four_mini_c_show) : ?>
                    <div class="col-lg-1">
                            ...
                            <div class="header-mini-cart">
                                ...
                                ?>
                                    <a href="<?php echo esc_url(wc_get_cart_url()); ?>">
                                        <?php
                                        echo '<img src="' . get_template_directory_uri() . '/images/icons/cart-3.png" alt="' . esc_attr('Cart', 'techeduem') . '">';
                                        echo '<span class="mini_cart_count_text"><span class="mini_cart_count">' . esc_html($woocommerce->cart->get_cart_contents_count()) . '</span>' . esc_html('Items', 'techeduem') . '</span>';
                                        ?>
                                    </a>
