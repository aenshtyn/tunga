...
if (!function_exists('techeduem_breadcrumbs')) {
	...
	function techeduem_breadcrumbs()
	{
		...
		$breadcrumbs_cat = $techeduem_opt['techeduem_breadcrumbs_post_cat'];
		...
		if (is_home() || is_front_page()) {
			...
			if (get_query_var('paged')) {
				...
				esc_html_e('Page', 'techeduem') . ' ' . get_query_var('paged');
				if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author()) echo ')';
			}
			echo '</ul>';
		}
	} // end techeduem_breadcrumbs()
}
