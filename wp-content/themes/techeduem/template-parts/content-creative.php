...
/**
 * Template part for displaying creative style posts
 *
...
<div class="col-md-6 grid-item">
	<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post grid-left-img mb-40'); ?>>
		<?php if (has_post_thumbnail()) : ?>
			<div class="blog-thumb">
				<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('techeduem_size_270X390'); ?></a>
			</div>
		<?php endif; ?>
		<div class="blog-content">
			...
			<?php if ('no' != $show_post_publish_date_meta || 'no' != $show_post_updated_date_meta || 'no' != $show_post_author_meta || 'no' != $show_post_comments_meta || 'no' != $show_post_categories_meta || 'no' != $show_post_tags_meta) : ?>
				<div class="blog-meta">
					...
					<?php if ('no' != $show_post_comments_meta && '' != $show_post_comments_meta) : ?>
