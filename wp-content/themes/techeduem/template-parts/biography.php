...
?>
<div class="author author-box clear">
	...
	<div class="author-info">
		<h4>
			<a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php echo get_the_author(); ?> <span>(<?php echo esc_attr($author_role); ?>)</span></a>
		</h4>
